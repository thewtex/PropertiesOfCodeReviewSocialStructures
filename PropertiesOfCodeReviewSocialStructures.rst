...
projects this can commonly only applies to issues where there are arguments
or disputes, but the taken to totalitarian extremes is represented by Figure
...
`GitHub <https://github.com>`_ where patches are review after `forking
<https://help.github.com/articles/fork-a-repo>`_ and
creating a `pull request
<https://help.github.com/articles/using-pull-requests>`_ for a repository.
...
perform a review that show up on a label rating board. An example is the code
...
`corporate <http://www.bonkersworld.net/organizational-charts/>`_
